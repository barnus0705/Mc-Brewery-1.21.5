...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> HOPS_BUSH_KEY = registerKey("hops_bush_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(BeerBrewery.MOD_ID, name));
    }
